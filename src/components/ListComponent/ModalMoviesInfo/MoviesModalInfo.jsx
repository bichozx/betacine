...
import { useDetailsMovies } from '../../../hooks/FetchDetailsMov&Ser.js/useDetailsMovies';
import { useMovieVideos } from '../../../hooks/FetchVideoMovie&Serie/useMovieVideos';

export const MoviesModalInfo = ({ movieId, onClose}) => {
  const [movieDetails, setMovieDetails] = useState(null);
  const [movieVideos, setMovieVideos] = useState(null);
  const [error, setError] = useState(null);
  const fetchMovieDetails = useDetailsMovies();
